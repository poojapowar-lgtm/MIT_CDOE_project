  ...
  return (
    <section className="life-campus">
      ...
      <p>MIT-ADT University was formally established in the year 2016 by the Government of Maharashtra
        ...
        it to issue degrees as specified in Section 22 of the UGC Act, 1956.</p>
      <p>The MIT Group acquired the land at Rajbaug, Loni Kalbhor — formerly owned by the late legendary
